...
var DeepLinker = /** @class */ (function () {
     ...
     * @param {?} _baseHref
     */
    function DeepLinker(_app, _serializer, _location, _moduleLoader, _baseCfr, _baseHref) {
        this._app = _app;
...
export function setupDeepLinker(app, serializer, location, moduleLoader, cfr, baseHref) {
    var /** @type {?} */ deepLinker = new DeepLinker(app, serializer, location, moduleLoader, cfr, baseHref);
    deepLinker.init();
    return deepLinker;
}
/**
