...
export class DeepLinker {
     ...
     * @param {?} _baseHref
     */
    constructor(_app, _serializer, _location, _moduleLoader, _baseCfr, _baseHref) {
        this._app = _app;
    ...
    init() {
        ...
        const /** @type {?} */ browserUrl = normalizeUrl(this._location.path(), this._baseHref);
...
function DeepLinker_tsickle_Closure_declarations() {
    ...
    /** @type {?} */
    DeepLinker.prototype._baseHref;
}
/**
 * @param {?} app
 * @param {?} serializer
 ...
 * @return {?}
 */
export function setupDeepLinker(app, serializer, location, moduleLoader, cfr, baseHref) {
    const /** @type {?} */ deepLinker = new DeepLinker(app, serializer, location, moduleLoader, cfr, baseHref);
    deepLinker.init();
    return deepLinker;
}
/**
 ...
 * @return {?}
 */
export function normalizeUrl(browserUrl, baseHref = '/') {
