        ...
        IonicModule.forRoot = function (appRoot, config, deepLinkConfig) {
            ...
            return {
                ...
                providers: [
                    ...
                    { provide: deep_linker_1.DeepLinker, useFactory: deep_linker_1.setupDeepLinker, deps: [app_1.App, url_serializer_1.UrlSerializer, common_1.Location, module_loader_1.ModuleLoader, core_1.ComponentFactoryResolver, [new core_1.Inject(common_1.APP_BASE_HREF), new core_1.Optional()]] },
                ]
            };
        };
